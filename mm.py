...
##        drive_links = {
##            "food_expense":"https://lh3.google.com/u/0/d/17ByDqX7NpaCNetUBSVkQM5K7Bu6JJzgp=w1440-h812-iv1",  # Replace with actual Drive ID
...
##            st.image(drive_links["food_expense"], caption="Consider budgeting better for food!", use_column_width=True)
##
##        if remaining_income < 3000:
##            st.write("⚠️ **Your remaining savings are very low!**")
##            st.image(drive_links["low_savings"], caption="Try to cut unnecessary expenses!", use_column_width=True)
##
##        if "other" in expense_details and expense_details["other"] > 7000:
##            st.write("🛒 **Your 'Other' expenses seem too high!**")
##            st.image(drive_links["high_other_expenses"], caption="Consider tracking your expenses!", use_column_width=True)
##
...
if liabilities > income:
    ...
    if st.button("📊 Calculate Budget"):
        ...
        drive_links = {
            "food_expense": "/Users/macbook/Pictures/tinkherhackimages",
            "low_savings": "/Users/macbook/Pictures/tinkherhackimages",
            "high_other_expenses": "/Users/macbook/Pictures/tinkherhackimages"
        }

        if "food" in expense_details and expense_details["food"] > 5000:
            st.write("🍕 **You are spending too much on food!**")
            
            st.image("food_expense", caption="Consider budgeting better for food!", use_container_width=300)

        if remaining_income < 3000:
            st.write("⚠️ **Your remaining savings are very low!**")
            st.image("low_savings", caption="Try to cut unnecessary expenses!", use_container_width=300)

        if "other" in expense_details and expense_details["other"] > 7000:
            st.write("🛒 **Your 'Other' expenses seem too high!**")
            st.image("high_other_expenses", caption="Consider tracking your expenses!", use_container_width=300)
